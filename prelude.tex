...
\newcommand{\highlightbox}[2][RoyalPurple!15]{\adjustbox{cframe=#1, bgcolor=#1}{\strut #2}}
...
\newcommand{\hashinput}{k_1 \concat k_2 \concat c_1\concat c_2 \concat\pk_1 \concat \pk_2 \concat \lbl}
\newcommand{\hashinputchallenges}{k^*_1 \concat k^*_2 \concat c^*_1 \concat c^*_2 \concat \pk_1 \concat \pk_2 \concat \lbl}
...
\newcommand{\paulnote}[1]{\textcolor{red}{$\langle\langle$ PAG: #1 $\rangle\rangle$}}
