...
module CCABad(S : Scheme, A : CCA_ADV) = {
   include var CCA(S,A) [-main0,main1]
...
lemma hop1_up2bad &m :
  ...
  `| Pr [ CCA(XWING(KEMS),A).main0() @ &m : res ] - 
     Pr [ CCA(XWING1(KEMS,PRF),A).main0() @ &m : res ] | <= 
      Pr [ CCABad(XWING1BadR(KEMS,PRF),A).main0() @ &m : XWING1.bad ]. 
proof.
move => A_ll dec_pure.
have -> : Pr [ CCA(XWING(KEMS),A).main0() @ &m : res ] = 
           Pr [ CCABad(XWING1BadL(KEMS,PRF),A).main0() @ &m : res ].
+ byequiv => //. 
...
have -> : Pr [ CCA(XWING1(KEMS,PRF),A).main0() @ &m : res ] = 
           Pr [ CCABad(XWING1BadR(KEMS,PRF),A).main0() @ &m : res ].
+ byequiv => //. 
...
have : 
  `|Pr[CCABad(XWING1BadL(KEMS, PRF), A).main0() @ &m : res] - Pr[CCABad(XWING1BadR(KEMS, PRF), A).main0() @ &m : res]| <=
     RealOrder.maxr Pr[CCABad(XWING1BadL(KEMS, PRF), A).main0() @ &m : XWING1.bad]
          Pr[CCABad(XWING1BadR(KEMS, PRF), A).main0() @ &m : XWING1.bad] by byupto.

have -> : 
  Pr[CCABad(XWING1BadL(KEMS, PRF), A).main0() @ &m : XWING1.bad] =
   Pr[CCABad(XWING1BadR(KEMS, PRF), A).main0() @ &m : XWING1.bad]; last by smt(). 
+ byequiv => //. 
  proc;inline *;wp.
...
lemma hop6_up2bad &m :
  (forall (O <: CCA_ORC{-A} ), islossless O.dec => islossless A(O).guess) =>
  (forall _st, phoare [ KEMS.dec : (glob KEMS) = _st ==> (glob KEMS) = _st] = 1%r) =>
  `| Pr [ CCA(XWING(KEMS),A).main1() @ &m : res ] - 
     Pr [ CCA(XWING1(KEMS,PRF),A).main1() @ &m : res ] | <= 
      Pr [ CCABad(XWING1BadR(KEMS,PRF),A).main1() @ &m : XWING1.bad ]. 
proof.
move => A_ll dec_pure.
have -> : Pr [ CCA(XWING(KEMS),A).main1() @ &m : res ] = 
           Pr [ CCABad(XWING1BadL(KEMS,PRF),A).main1() @ &m : res ].
+ byequiv => //. 
  proc;inline *;wp; call(: ={glob CCA, glob KEMS}
                       /\ CCA.sk.`1{1} = XWING1._sk1{2}
                       /\ CCA.sk.`2{1} = XWING1._sk2{2}
...
have -> : Pr [ CCA(XWING1(KEMS,PRF),A).main1() @ &m : res ] = 
           Pr [ CCABad(XWING1BadR(KEMS,PRF),A).main1() @ &m : res ].
+ byequiv => //. 
  proc;inline *;wp; call(: ={glob CCA, glob KEMS, XWING1._sk1, XWING1._sk2, XWING1._pk2, XWING1._kb1, XWING1._c1, glob PRF}). 
  + proc;inline *. 
    sp; if;1,3: by auto => />;smt().
...
have : 
  `|Pr[CCABad(XWING1BadL(KEMS, PRF), A).main1() @ &m : res] - Pr[CCABad(XWING1BadR(KEMS, PRF), A).main1() @ &m : res]| <=
     RealOrder.maxr Pr[CCABad(XWING1BadL(KEMS, PRF), A).main1() @ &m : XWING1.bad]
          Pr[CCABad(XWING1BadR(KEMS, PRF), A).main1() @ &m : XWING1.bad] by byupto.

have -> : 
  Pr[CCABad(XWING1BadL(KEMS, PRF), A).main1() @ &m : XWING1.bad] =
   Pr[CCABad(XWING1BadR(KEMS, PRF), A).main1() @ &m : XWING1.bad]; last by smt(). 
+ byequiv => //. 
  proc;inline *;wp.
  call(: XWING1.bad, ={glob CCA, glob KEMS, glob XWING1, glob PRF},={XWING1.bad}). 
  + proc;inline *. 
...
module (D0(KEMS : KEM.Scheme, A : CCA_ADV) : Distinguisher) (O : PRF_Oracles) = {
   proc distinguish = CCA(XWINGD0(KEMS,O),A).main0
}.
...
module (D1(KEMS : KEM.Scheme, A : CCA_ADV) : Distinguisher) (O : PRF_Oracles) = {
   proc distinguish = CCA(XWINGD1(KEMS,O),A).main1
}.
...
lemma hop2_left &m :
  Pr [ CCA(XWING1(KEMS,PRF),A).main0() @ &m : res ] = 
    Pr [ KEM.CCA(KEMS,B2(A)).main0() @ &m : res ]. 
proof.
byequiv => //. 
proc;inline *.
...
lemma hop2_right &m :
  Pr [ CCA(XWING2(KEMS,PRF),A).main0() @ &m : res ] = 
    Pr [ KEM.CCA(KEMS,B2(A)).main1() @ &m : res ]. 
proof.
byequiv => //. 
proc;inline *.
wp;call(: ={glob KEMS,XWING1._sk2,XWING1._pk2, XWING1._c1} 
...
lemma hop3_right &m :
  Pr [ CCA(XWING2(KEMS,RF),A).main0() @ &m : res ] = 
...
lemma hop4_right &m :
  Pr [ CCA(XWING2(KEMS,PRF),A).main1() @ &m : res ] = 
...
lemma hop5_left &m :
  Pr [ CCA(XWING2(KEMS,PRF),A).main1() @ &m : res ] = 
    Pr [ KEM.CCA(KEMS,B4(A)).main1() @ &m : res ]. 
proof.
byequiv => //. 
proc;inline *.
wp;call(: ={glob KEMS,XWING1._sk2,XWING1._pk2, XWING1._c1} 
...
lemma hop5_right &m :
  Pr [ CCA(XWING1(KEMS,PRF),A).main1() @ &m : res ] = 
    Pr [ KEM.CCA(KEMS,B4(A)).main0() @ &m : res ]. 
proof.
byequiv => //. 
proc;inline *.
wp;call(: ={glob KEMS,XWING1._sk2,XWING1._pk2, XWING1._c1} 
...
lemma pre_final &m : 
 ...
 `| Pr [ CCA(XWING(KEMS),A).main0() @ &m : res ] - 
       Pr [ CCA(XWING(KEMS),A).main1() @ &m : res ] | <= 
         ...
         `| Pr [ KEM.CCA(KEMS,B2(A)).main0() @ &m : res ] - Pr [ KEM.CCA(KEMS,B2(A)).main1() @ &m : res ]| + 
         `| Pr [ KEM.CCA(KEMS,B4(A)).main0() @ &m : res ] - Pr [ KEM.CCA(KEMS,B4(A)).main1() @ &m : res ]| + 
