...
\begin{definition}[Pseudorandom Function (PRF)]
    \label{def:prf}
    For a finite keyspace $\mathcal{K}$, input space $\mathcal{X}$, finite output space $\mathcal{Y}$, and an efficiently computable function $f: \mathcal{K} \times \mathcal{X} \foutput \mathcal{Y}$, we define the PRF advantage of adversary $\adversary{A}$ based on the experiments in Figure \ref{fig:prf-game} as
...
\begin{gamefigure}{PRF security games.}{fig:prf-game}
    ...
    \begin{definition}[\hqb] \label{def:hqb}
        ...
        \begin{theorem}
            ...
            \[ \advantage{\hqb, \adversary{A}}{\cca} \leq 2 \Delta_\nominalgroup +  \advantage{\nominalgroup, \adversary{B}}{\sdh} + \advantage{\kem, \adversary{C}}{\kemcoll}. \]
            %
            The run-times of $\adversary{B}$ and $\adversary{C}$ are roughly the same as of $\adversary{A}$.
                                                ...
                                                \begin{gamefigure}{Adversary $\adversary{B}$.}{fig:sdh}
                                                    \begin{games}{2}
                                                        \begin{gameenv}{\textbf{Adversary} $\adversary{B}^{\odh(\cdot, \cdot)}(X, Y)$}
                                                            ...
                                                            \State $\pk_2 \assign X$
                                                            \State $\pk \assign (\pk_1, \pk_2)$
                                                            \State $(k^*_1, c^*_1) \sample \kem.\enc(\pk_2)$
                                                            \State $c^*_2 \assign Y$
                                                            \State $c^* \assign (c^*_1, c^*_2)$
                                                            \State $k^* \sample \bits^{n}$
                                                            \State $b' \assign \adversary{A}^{\dec(\cdot), H(\cdot)}(\pk, c^*, k^*)$
                                                        ...
                                                        \begin{gameenv}{\oracledec}
                                                            \State $\ifthen{c = c^*}$
                                                                ...
                                                                \State $\ifthen{k_1 \compare \bot}$
                                                                    \State \quad \Return $\bot$
                                                                    \State $\ifthen{\pset{E}[(c_2, k_1)] = \bot}$
                                                                        \State \quad $\pset{E}[(c_2, k_1)] \sample \bits^{n}$
                                                                        \State \Return $\pset{E}[(c_2, k_1)]$
                                                                        \Statex
                                                                        \State \underline{\oraclerom{}{m}}
                                                                        \State $\ifthen{\hashinput = m}$
                                                                            \State \quad $\ifthen{\odh(Y, k_2) = 1}$ \label{line:found_cdh}
                                                                                \State \qquad stop with $k_2$
                                                                                \State \quad $\ifthen{\odh(c_2, k_2) = 1}$ \label{line:is_valid_query}
                                                                                    \State \qquad $\ifthen{\pset{E}[(c_2, k_1)] = \bot}$
                                                                                        \State \qquad \quad $\pset{E}[(c_2, k_1)] \sample \bits^{n}$
                                                                                        \State \qquad \Return $\pset{E}[(c_2, k_1)]$
                                                                                        \State $\ifthen{\ROMtable[m] = \bot}$
                                                                                            \State \quad $\ROMtable[m] \sample \bits^{n}$
                                                                                            \State \Return $\ROMtable[m]$
                                                                                        \end{gameenv}
                                                                                ...
                                                                                Therefore, the shared challenge key $k^*$ is supposed to be $H_2(label \concat k^*_1 \concat \nexp(Y, x) \concat c^*_2 \concat pk_2)$.
